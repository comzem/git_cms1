                  ...
                  <tr>
                    <td align="center" valign="top" bgcolor="#FFFFEE"><table width="760" height="351" border="0" cellpadding="6" cellspacing="0" class="px14">
                      ...
                      <tr>
                        ...
                        <td valign="top">
			              <input type="text" name="order_no" maxlength="50" size="18" readonly value="<?php echo $mch_vno ?>" font style="color:#000000;font-size:14px;"></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td valign="top"><input type="text" name="order_price" maxlength="50" size="18" onKeyUp="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" font style="color:#000000;font-size:14px;" value="<?php echo $_GET['price'] ?>"> 
                        元（格式：500.01）</td>
                      </tr>
                       <tr>
